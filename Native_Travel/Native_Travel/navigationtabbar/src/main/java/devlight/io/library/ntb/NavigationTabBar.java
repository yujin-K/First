...
public class NavigationTabBar extends View implements ViewPager.OnPageChangeListener {
    ...
    protected final static int DEFAULT_INACTIVE_COLOR = Color.parseColor("#FDFDE9"); // 글자색
    protected final static int DEFAULT_ACTIVE_COLOR = Color.WHITE;
    protected final static int DEFAULT_BG_COLOR = Color.parseColor("#004771");  //여기 네이게이션 탭바 색깔 지정
